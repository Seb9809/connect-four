...
const getFirstOpenCellForColumn = (colIndex) => {
  ...
  const colWithoutTop = column.slice(0, 6);
...
const checkStatusOfTheGame = (cell) => {
  ...
  gameIsLive = false;
  statusSpan.textContent = "The game ended with a tie";
};
